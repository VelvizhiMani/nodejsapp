...
class KnowBodyList extends React.Component {
  render() {
    return (
      <>
            ...
            <div class="row">
              ...
              <div class="box">
                <div class="box-header">
                  <div class="col-md-6">
                    <h3 class="box-title" style={{color:'#fe5e00',fontWeight:'500',marginTop:'10px'}}>Know Your Body List</h3>
                    </div>
                    <div class="col-md-6">
                    <Link to="/knowbodyadd">
                      <button type="button" class="btn btn-primary pull-right">
                        <i class="fa fa-plus"></i> &nbsp;Know Your Body Add</button></Link>
                    </div>
                </div>
                <div class="box-body">
